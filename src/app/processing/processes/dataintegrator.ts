...
export class DataIntegrator extends AbstractDataBlock{
    ...
    private load(data:Data):Data{
        ...
        if (this.currentData&&this.currentTimeStep){
            var step:number = ((data.Timestamp?data.Timestamp:data.Data[0]) - this.currentTimeStep)/1000.0;
            ...
            integralStep.Timestamp = data.Timestamp?data.Timestamp:data.Data[0];
        ...
        this.currentTimeStep = data.Timestamp?data.Timestamp:data.Data[0];
        return integralStep;
    }
